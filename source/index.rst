...
RoboFab is available as a couple of relatively easy to install packages. If you're just starting with RoboFab, or you just want to make UFO's, :doc:`this is the place to start <docs_intro/download>`.
...
.. toctree::
   ...
   docs_intro/index.rst
   docs_objects/index.rst
   docs_howtos/index.rst
   docs_talks/index.rst
   docs_api/index.rst
